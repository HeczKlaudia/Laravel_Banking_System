...
<div class="off-canvas-content" data-off-canvas-content>
    ...
    <div class="body">
        <div class="row small-up-2 medium-up-3 large-up-4">
            <div class="column">
                <div class="card-body">
                    <h2 class="cim">Kifizetés saját számláról</h2>
                ...
                <div class="szamla-adatok">
                    <form id="addform" action="{{ route('withdraw-amount') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="adatok-div">
                            <label for="">Ügyfél számlaszáma:</label>
                        ...
                        <dl>
                            <p class="szoveg">Kifizetett összeg:</p>
