    ...
    <div class="row small-up-2 medium-up-3 large-up-4">
        <div class="margo">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    <label for="last_name" class="col-md-4 col-form-label text-md-end">{{ __('Vezetéknév') }}</label>
                ...
                <div class="row mb-3">
                    <label for="first_name" class="col-md-4 col-form-label text-md-end">{{ __('Keresztnév') }}</label>
                ...
                <div class="row mb-3">
                    <label for="phone_number" class="col-md-4 col-form-label text-md-end">{{ __('Telefonszám') }}</label>
                ...
                <div class="row mb-3">
                    <label for="birth_date" class="col-md-4 col-form-label text-md-end">{{ __('Születési év (1990-12-12)') }}</label>
